    ...
    public partial class Form2 : Form
    {
        ...
        public void exportgridtoexcel(DataGridView dgw, string filename)
        {
            ...
            if (saveFileDialogeExcel.ShowDialog() == DialogResult.OK)
            {
                ...
                //Type.Missing sesuai dengan jumlah kolom di datagridview
            }
            app.Quit();
        ...
        private void expintoPDF_Click(object sender, EventArgs e)
        {
            exportgridtopdf(dataGridView1, "text");
        }

        private void expintoExcel_Click(object sender, EventArgs e)
        {
